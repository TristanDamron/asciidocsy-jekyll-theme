...
////
  Per https://github.com/asciidoctor/jekyll-asciidoc#overview
  You can set a site-baseurl variable in your _config.yml file
  that is globally available to all Asciidoc content.

  Use this to prepend the base url to links on the page.
////

link:{site-baseurl}/docs[[big]*Go straight to the docs for an example of AsciiDocsy in action.*]
====
